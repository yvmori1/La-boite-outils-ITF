...
1. **Courtoisie (Ye Ui / [예의](../audio/lexique/Ye-Ui.m4a)) :** Promouvoir l'esprit de concessions mutuelles, être poli, se conduire selon l'étiquette et respecter la dignité d'autrui.
2. **Intégrité (Yum Chi / [염치](../audio/lexique/Yum-Chi.m4a)) :** Être capable de discerner le bien du mal, d'éprouver un regret sincère en cas de faute et de refuser tout compromis avec sa conscience.
3. **Persévérance (In Nae / [인내](../audio/lexique/In-Nae.m4a)) :** Faire preuve d'une patience constante pour surmonter les difficultés rencontrées sur sa voie. "La patience mène au mérite et à la vertu".
4. **Contrôle de soi (Guk Gi / [극기](../audio/lexique/Guk-Gi.m4a)) :** Maîtriser ses émotions, ses désirs et ses pulsions physiques, un principe essentiel pour éviter les blessures au combat.
5. **Esprit indomptable (Baekjul Boolgool / [백절불굴](../audio/lexique/Baekjul-Boolgool.m4a) / Courage) :** Agir avec honnêteté et humilité, mais se dresser sans peur ni hésitation face à l'injustice, quelle que soit la puissance de l'opposition.
...
* **Dojang ([도장](../audio/lexique/Dojang.m4a)) :** Salle d'entraînement officielle.
* **Tul ([틀](../audio/lexique/Tul.m4a)) :** Forme ou enchaînement codifié de mouvements de combat simulé (24 formes de l'école Chang-Hun).
* **Charyot ([차렷](../audio/lexique/Charyot.m4a)) :** "Attention !" (Position protocolaire de recentrage).
* **Swiyo ([쉬어](../audio/grammaire/Swiyo.m4a)) :** "Repos !" ou "Relâchez !".
* **Kyong Ye Jase ([경례 자세](../audio/grammaire/Kyong-Ye-Jase.m4a)) :** Posture officielle de salut.
* **Taekwon-Do ([태권도](../audio/grammaire/Taekwon-Do.m4a)) :** Littéralement : *Tae* (frapper ou briser avec le pied), *Kwon* (frapper ou briser avec le poing), *Do* (la voie, l'art, le cheminement spirituel).
...
* **Baro ([바로](../audio/grammaire/Baro.m4a)) — En poursuite / Homologue :** La main ou le bras qui exécute l'action (frappe ou blocage) est du **même côté** que la jambe placée à l'avant.
* **Bandae ([반대](../audio/grammaire/Bandae.m4a)) — Contraire / Hétérologue :** La main ou le bras qui exécute l'action est du **côté opposé** à la jambe placée à l'avant.

#### 3. Direction et Trajectoire (Banghyang / [방향](../audio/grammaire/Banghyang.m4a))

* **Ap ([앞](../audio/grammaire/Ap.m4a)) :** De face.
* **Yop ([옆](../audio/grammaire/Yop.m4a)) :** Latéral / De côté.
* **Dollyo ([돌려](../audio/grammaire/Dollyo.m4a)) :** Circulaire.
* **Ollyo ([올려](../audio/grammaire/Ollyo.m4a)) :** Ascendant / Montant.
* **Naeryo ([내려](../audio/grammaire/Naeryo.m4a)) :** Descendant.
* **Anuro ([안으로](../audio/grammaire/Anuro.m4a)) :** De l'extérieur vers l'intérieur.
* **Bakuro ([밖으로](../audio/grammaire/Bakuro.m4a)) :** De l'intérieur vers l'extérieur.
...
* **Didimyo nagagi ([디디며나가기](../audio/grammaire/Didimyo-nagagi.m4a)) :** Pas vers l'avant (avancer d'un pas).
* **Didimyo duruogi ([디디며두루오기](../audio/grammaire/Didimyo-duruogi.m4a)) :** Pas vers l'arrière (reculer d'un pas).
* **Ibo omgyo didimyo nagagi ([이보옮겨디디며나가기](../audio/grammaire/Ibo-omgyo-didimyo-nagagi.m4a)) :** Double pas vers l'avant.
* **Ibo omgyo didimyo duruggi ([이보옮겨디디며두루기](../audio/grammaire/Ibo-omgyo-didimyo-duruggi.m4a)) :** Double pas vers l'arrière.
* **Gujari dolgi ([구자리돌기](../audio/grammaire/Gujari-dolgi.m4a)) :** Pivotement/Rotation sur place.
* **Dwiro omgyo didimyo dolgi ([뒤로옮겨디디며돌기](../audio/grammaire/Dwiro-omgyo-didimyo-dolgi.m4a)) :** Pivotement complet sur un pas arrière.
* **Ibo omgyo didimyo dolgi ([이보옮겨디디며돌기](../audio/grammaire/Ibo-omgyo-didimyo-dolgi.m4a)) :** Pivotement complet sur deux pas.
* **Mikulgi ([미끌기](../audio/grammaire/Mikulgi.m4a)) :** Pas chassé / Glissement rasant au sol.
* **Omgyo didigo mikulmyo dolgi ([옮겨디디고미끌며돌기](../audio/grammaire/Omgyo-didigo-mikulmyo-dolgi.m4a)) :** Pivotement combiné sur un pas chassé.
* **Durogamyo jajunbal ([두로가며자준발](../audio/grammaire/Durogamyo-jajunbal.m4a)) :** Transfert ou décalage rapide de pied.
...
* **Busigi ([부시기](../audio/grammaire/Busigi.m4a)) — Fouetté (Snap) :** Vitesse explosive et réarmement instantané du genou.
* **Jirugi ([지르기](../audio/grammaire/Jirugi.m4a)) — Perçant (Piston) :** Poussée rectiligne lourde avec engagement du bassin.
* **Tulgi ([뚫기](../audio/grammaire/Tulgi.m4a)) — Pique / Transperçant :** Pénétration incisive visant une faille anatomique étroite.
* **Milgi ([밀기](../audio/grammaire/Milgi.m4a)) — Poussant :** Pression continue en force projetant le centre de gravité.
* **Olligi ([올리기](../audio/grammaire/Olligi.m4a)) — Montant tendu :** Élévation rectiligne sans aucune pliure du genou.
* **Suroh ([쓸어](../audio/grammaire/Suroh.m4a)) — Balayé :** Fauchage circulaire rasant le sol.
* **Naeryo ([내려](../audio/grammaire/Naeryo.m4a)) — Descendant (Hache) :** Percussion lourde du haut vers le bas.
* **Nullo ([눌러](../audio/grammaire/Nullo.m4a)) — Pressant :** Écrasement vertical vers le bas pour briser un appui.
* **Goro ([걸어](../audio/grammaire/Goro.m4a)) — Crocheté :** Trajectoire circulaire dépassant la cible pour la ramener en crochet.
* **Bituro ([비틀어](../audio/grammaire/Bituro.m4a)) — Vrillé :** Départ axial s'ouvrant en torsion vers l'extérieur à l'impact.
