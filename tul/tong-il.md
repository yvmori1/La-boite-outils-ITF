...
1. Déplacer le pied droit vers C pour former une position de marche gauche vers D tout en exécutant un coup de poing moyen vers D avec un poings jumelés.
...
4. Exécuter un blocage intérieur bas vers D avec la paume droite tout en formant une position de marche gauche vers D, en glissant le pied droit, et en amenant le gauche côté poing en avant de la épaule droite.
   *(Gunnun so sonbadak najunde anuro bandae makgi)*
...
12. Déplacer le pied droit vers D, pour former une position de marche droite vers D tout en exécutant un blocage latéral haut vers D avec le revers de la main droite.
   *(Gunnun so sonkal dung nopunde yop makgi)*
...
13. Exécuter un blocage latéral moyen vers D avec le revers de la main gauche tout en maintenant une position de marche droite vers D.
   *(Gunnun so sonkal dung kaunde bandae yop makgi)*
...
17. Abaisser le pied droit vers C en un en écrasant mouvement, pour former une position en L gauche vers C tout en exécutant une frappe descendante vers C avec le revers du poing droit.
   *(Niunja so dung joomuk bandae naeryo taerigi)*
...
26. Ramener le pied gauche vers le pied droit pour former une position fermée vers C tout en amenant les deux arrière mains en avant du abaisser abdomen en un circulaire mouvement, en frappant la paume gauche avec le tranchant de la main droite.
   *(Moa sogi)*
...
28. Exécuter un coup de poing haut vers D avec le poing droit tout en maintenant une position de marche gauche vers D.
   *(Gunnun so nopunde bandae jirugi)*
29. Glisser vers D pour former une position en L gauche vers D tout en exécutant un coup de poing renversé vers D avec le poing gauche, en amenant le droit côté poing en avant de la épaule gauche.
   *(Niunja so baro dwijibo jirugi)*
30. Déplacer le pied droit vers C, pour former une position de marche gauche vers D tout en exécutant une pique haute avec le droit angle bout des doigts.
...
32. Exécuter un coup de poing haut vers C avec le poing gauche tout en maintenant une position de marche droite vers C.
   *(Gunnun so nopunde bandae jirugi)*
33. Glisser vers C pour former une position en L droite vers C tout en exécutant un coup de poing renversé vers C avec le poing droit, en amenant le gauche côté poing en avant de la épaule droite.
   *(Niunja so baro dwijibo jirugi)*
34. Déplacer le pied gauche vers D, pour former une position de marche droite vers C tout en exécutant une pique haute avec le gauche angle bout des doigts.
   *(Gunnun so homi sonkut nopunde bandae tulgi)*
35. Exécuter un blocage de garde bas vers C avec un revers de la main en un circulaire mouvement tout en formant une position en L gauche vers C, en pivotant avec le pied gauche.
   *(Niunja so sonkal dung najunde daebi makgi)*
36. Exécuter un blocage de garde bas vers D avec un revers de la main en un circulaire mouvement tout en formant une position en L droite vers D, en pivotant avec le pied droit.
   *(Niunja so sonkal dung najunde daebi makgi)*
37. Exécuter un blocage bas vers D avec l'avant-bras droit et un blocage extérieur moyen vers D avec le tranchant de la main gauche tout en formant une position de marche gauche vers D, en glissant le pied gauche.
   *(Gunnun so sonkal kaunde baro bakuro makgi wa palmok najunde bandae makgi)*
...
50. Exécuter un blocage poussée moyen vers C avec la paume gauche tout en maintenant une position de marche droite vers C.
   *(Gunnun so sonbadak kaunde bandae miro makgi)*
...
53. Exécuter un blocage circulaire vers B avec le tranchant de la main gauche tout en formant une position de marche droite vers BD.
   *(Gunnun so sonkal dollimyo makgi)*
54. Exécuter un coup de pied latéral perçant haut vers D avec le pied droit, pour former un blocage de garde de l'avant-bras, puis abaisser il vers le pied gauche pour former une position fermée vers D tout en exécutant une double pique arrière du coude latérale.
